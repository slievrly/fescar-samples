...
public class TransferDataPrepares {
    ...
    protected void prepareTable(DataSource dataSource) {
        ...
        try {
            ...
            s.execute(
                "CREATE TABLE  business_activity  ( tx_id  varchar(128) NOT NULL , gmt_create  TIMESTAMP(6) , "
            ...
            s.execute(
                "CREATE TABLE  business_action  (  tx_id  varchar(128) , action_id  varchar(64)  , gmt_create  "
